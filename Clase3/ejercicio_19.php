...
public static function MostrarAutoCSV(Auto $auto)
{
    $cadena= "Marca: $auto->_marca, ".
    "Color: $auto->_color, ".
    "Precio: $auto->_precio, ".
    "fecha de Compra: $auto->_fecha";
    return $cadena;
}
...
public static function AltaDeAutos($autos, $nombre)
{
    $archivo = fopen($nombre , "w+");

    foreach($autos as $auto)
    {
        echo fwrite($archivo, Auto::MostrarAuto($auto).PHP_EOL);
    }
